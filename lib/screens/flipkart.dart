...
import 'package:flutter_app/helpers/productoperations.dart';
...
class _FlipKartDesignState extends State<FlipKartDesign> {
  ...
  _loadProducts() {
    final List<String> urls = [
      'https://icons.iconseeker.com/png/fullsize/quickpix-2007/apple-iphone-1.png',
      'https://www.apple.com/newsroom/images/product/iphone/standard/Apple_new-iphone-se-app-store-screen_04152020_carousel.jpg.large.jpg',
